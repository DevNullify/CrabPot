...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "examples:\n"
            "  crabpot init          Check/install prerequisites\n"
            "  crabpot setup         Build hardened image + onboarding\n"
    ...
    subparsers.add_parser("init", help="Check/install prerequisites (Docker, Python deps)")
    subparsers.add_parser("setup", help="Build hardened image, generate configs, run onboarding")
